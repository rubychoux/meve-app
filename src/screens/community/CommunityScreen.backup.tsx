      ...
      >
        ...
        <View style={styles.beautyReportPills}>
          {profile.skinScore != null && (
            ...
            >
              <Text style={[styles.reportPillText, { color: '#2D3A6B' }]}>
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 18, fontWeight: '800', color: '#1A1A1F' },
  headerSubtitle: {
    fontSize: 12,
    color: '#8A8A9A',
    marginTop: 2,
  ...
  emptyTitle: { fontSize: 16, fontWeight: '700', color: '#1A1A1F', textAlign: 'center' },
  ...
  postName: { fontSize: 15, fontWeight: '700', color: '#1A1A1F' },
  ...
  tagBlueText: { fontSize: 11, color: '#2D3A6B', fontWeight: '600' },
  ...
  postContent: { fontSize: 14, color: '#1A1A1F', lineHeight: 22, marginTop: 4 },
