        ...
        <View style={styles.compactHeader}>
          <View style={styles.compactHeaderMain}>
            <View style={styles.headerTopRow}>
              <Text style={styles.headerWordmark}>meve</Text>
                      ...
                      <View key={`${scan.date}-${i}`} style={styles.barWrapper}>
                        <View
                          style={[
                            ...
                            {
                              height: barHeight,
                              backgroundColor: isLast ? '#2D3A6B' : '#C8DFF0',
                            },
                          ]}
                        />
        ...
        >
          ...
          >
            <View style={styles.hCardHeader}>
              <BubbleIcon icon="camera" size={28} iconSize={14} colors={['#A8D5E8', '#2D3A6B']} />
            ...
            <TouchableOpacity onPress={goToFaceScanner}>
              <Text style={[styles.hCardCta, { color: '#2D3A6B' }]}>
          ...
          >
            <View style={styles.hCardHeader}>
              <BubbleIcon icon="trending-up" size={28} iconSize={14} colors={['#A8D5E8', '#2D3A6B']} />
            ...
            <TouchableOpacity onPress={goToFaceScanner}>
              <Text style={[styles.hCardCta, { color: '#2D3A6B' }]}>자세히 보기 →</Text>
            </TouchableOpacity>
          </GlassCard>
          ...
          {lastSkinScore != null && (
            ...
            >
              ...
              <Text style={[styles.activityCardValue, { color: '#2D3A6B' }]}>
                {lastSkinScore}점
              </Text>
...
const styles = StyleSheet.create({
  ...
  ddayPillUnset: {
    ...
    borderColor: 'rgba(45,58,107,0.25)',
    borderWidth: 0.5,
  ...
  ampmBtnActive: { borderColor: '#2D3A6B', backgroundColor: '#E8F4FD' },
  ampmBtnText: { fontSize: 14, color: '#8A8A9A', fontWeight: '600' },
  ampmBtnTextActive: { color: '#1A1A1F', fontWeight: '700' },
  scanBtn: {
    backgroundColor: '#2D3A6B',
    borderRadius: 50,
    padding: 14,
  ...
  skinRecordLink: { fontSize: 13, color: '#2D3A6B', fontWeight: '600' },
  scoreRow: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'space-between',
  ...
  scoreValue: { fontSize: 28, fontWeight: '800', color: '#2D3A6B' },
  scoreDiffBadge: {
  ...
  noRoutineCtaText: { fontSize: 12, color: '#2D3A6B', fontWeight: '500' },
